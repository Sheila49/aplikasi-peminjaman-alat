  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-950 via-gray-900 to-black relative overflow-hidden">
      ...
      <div className="w-full max-w-md px-6 relative z-10 animate-slide-up py-8">
        ...
        <div className="relative rounded-3xl bg-gradient-to-br from-gray-800/70 to-gray-900/70 backdrop-blur-2xl p-8 shadow-2xl border border-gray-700/50 animate-scale-in" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="relative">
            ...
            <div className="mb-6 animate-fade-in" style={{ animationDelay: '0.4s' }}>
              ...
              <p className="text-gray-400 text-sm mt-1">Isi data berikut untuk membuat akun</p>
            </div>
              ...
              <div className="animate-slide-right" style={{ animationDelay: '0.5s' }}>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-3.5 rounded-xl bg-gray-900/60 border text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 transition-all duration-300 ${
                      errors.name
              ...
              <div className="animate-slide-right" style={{ animationDelay: '0.7s' }}>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    id="password"
                    placeholder="••••••••"
                    className={`w-full pl-12 pr-12 py-3.5 rounded-xl bg-gray-900/60 border text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 transition-all duration-300 ${
                      errors.password
                        ? "border-red-500 focus:border-red-500 focus:ring-red-500/50"
                        : "border-gray-700 focus:border-blue-500 focus:ring-blue-500/50"
                    }`}
        ...
        {/* Footer */}
        <p className="mt-6 text-center text-xs text-gray-500 animate-fade-in" style={{ animationDelay: '1.1s' }}>
